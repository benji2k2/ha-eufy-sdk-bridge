...
function fakeEufy() {
  ...
  const devices = {
    ...
    SIRENCAM1: {
      describe: () => ({ sn: "SIRENCAM1", name: "Siren cam", model: "T8114", modelName: "eufyCam", codec: "camera", capabilities: ["camera", "video", "siren"] }),
  ...
  return {
    ...
    async getDevices() { return [{ sn: "CAM1" }, { sn: "SIRENCAM1" }, { sn: "SENSOR1" }]; },
